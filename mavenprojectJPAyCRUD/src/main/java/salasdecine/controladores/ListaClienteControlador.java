...
public class ListaClienteControlador implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		try {
			/* LO USABAMOS CON LA API, CUANDO LOS VALORES NO VENIAN DE LA BBDD
			resultadoListaCliente=api.listaCliente(); //OBTENEMOS DEL API Y GUARDAMOS EL CLIENTE 
			*/
			//AHORA USAMOS LO MISMO, PERO EL NUEVO METODO DE APICINE QUE TOMA LOS VALORES DE LA BBDD
			resultadoListaCliente=api.listaClienteDAO();
