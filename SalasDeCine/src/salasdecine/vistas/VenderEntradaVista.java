...
public class VenderEntradaVista extends JPanel {
	...
	public VenderEntradaVista() {
		...
		radiobutonhora.setBounds(56, 313, 102, 20);
		add(radiobutonhora);
		...
		radio19.setBounds(56, 336, 102, 20);
		add(radio19);
		...
		radio22.setBounds(56, 359, 102, 20);
		add(radio22);
		...
		botonclientes.setBounds(483, 194, 128, 20);
		add(botonclientes);
		...
		comboBoxFuncion.setBounds(168, 71, 42, 22);
		add(comboBoxFuncion);

		comboBoxCliente = new JComboBox();
		comboBoxCliente.setBounds(613, 71, 42, 22);
		add(comboBoxCliente);
	...
	public int getFuncionSeleccionada() {
		return comboBoxFuncion.getSelectedIndex(); 
	}
